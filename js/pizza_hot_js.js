...
const PIZZA_HOT_CACHE_KEY =
    "pizza_hot_cache";

const PIZZA_HOT_CACHE_TIME_KEY =
    "pizza_hot_cache_time";

const PIZZA_HOT_CACHE_DURATION =
    60 * 60 * 1000;

const PIZZA_HOT_RETRY_DELAY =
    1000;

const PIZZA_HOT_LOADING_IMAGE =
