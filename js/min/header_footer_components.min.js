class SiteHeader extends HTMLElement {
    connectedCallback() {
        ...
        const e = this.querySelector(".nav-toggle"), n = this.querySelector(".primary-nav"), a = this.querySelector(".nav-dropdown"),
            t = this.querySelector(".nav-dropdown__trigger");
        e.addEventListener("click", () => {
            const a = "true" === e.getAttribute("aria-expanded");
            e.setAttribute("aria-expanded", String(!a)), n.classList.toggle("is-open", !a)
        }), t.addEventListener("click", e => {
            e.stopPropagation();
            const n = "true" === t.getAttribute("aria-expanded");
            t.setAttribute("aria-expanded", String(!n)), a.classList.toggle("is-open", !n)
        }), document.addEventListener("click", e => {
            a.contains(e.target) || (a.classList.remove("is-open"), t.setAttribute("aria-expanded", "false"))
        }), window.addEventListener("resize", () => {
            window.innerWidth > 760 && (n.classList.remove("is-open"), e.setAttribute("aria-expanded", "false"))
        })
    }
}
